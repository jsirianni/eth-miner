...
default[:miner][:packages] = ["wget", "curl", "libcurl3", "lm-sensors"]
...
default[:miner][:amd][:archive]   = "#{node[:miner][:driver_version]}.tar.xz"
default[:miner][:amd][:src_dir]   = "#{node[:miner][:instmedia]}/#{node[:miner][:driver_version]}"
...
default[:miner][:claymore][:executable] = "#{node[:miner][:inst_dir]}/ethdcrminer64"
...
default[:miner][:log][:enable]   = false
